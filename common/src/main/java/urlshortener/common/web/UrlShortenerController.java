...
public class UrlShortenerController {
	...
	/** 
	 * M�todo que gestiona las redirecciones a las urls acortadas
	...
	/**
	 * Comprueba si el cliente que pide la redirecc�on, ha pedido otra redireccion al mismo link
	...
	/**
	 * Redirige a la pagina de publicidad si el link la tiene y sino redirige a la p�gina directamente.
	 */
	...
	/**
	 * Crea una redirecc�on a una p�gina 404 de error
	 */
